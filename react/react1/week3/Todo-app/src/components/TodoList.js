...
export const TodoList = () => {
    ...
    const inputDescriptionHandler = (e) => { setDescription(e.target.value) }
    const inputDeadlineHandler = (e) => { setDeadline(e.target.value) }
    ...
    return (
        <>
            <label className="todo-input" htmlFor="description">Description <input type="text" name="description" value={description} onChange={inputDescriptionHandler} />
            </label>
            <label className="todo-input" htmlFor="deadline">Deadline<input type="date" min={disablePastDate()} name="deadline" value={deadline} onChange={inputDeadlineHandler} />
            </label>
